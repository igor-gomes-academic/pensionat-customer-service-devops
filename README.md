...
**Booking Backend:** [pensionat-booking-backend-devops](https://github.com/igor-gomes-academic/pensionat-booking-backend-devops)
...
```text
pensionat/
├── pensionat-booking-frontend-devops/
...
The application was originally developed by:
...
This repository is an individual DevOps continuation maintained by Igor Gomes. The CI/CD pipelines, container publishing, deployment configuration and related automation are implemented individually as part of the DevOps course.
